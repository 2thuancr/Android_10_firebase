...
public class VideosFireStoreAdapter extends FirestoreRecyclerAdapter<Video1Model, VideosFireStoreAdapter.MyHolder> {
    private boolean isFav = false;

    public VideosFireStoreAdapter(@NonNull FirestoreRecyclerOptions<Video1Model> options) {
        super(options);
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull VideosFireStoreAdapter.MyHolder holder, int position, @NonNull Video1Model model) {
